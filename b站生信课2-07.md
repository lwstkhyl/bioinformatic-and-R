...
dev.off();
```
![随机森林筛选特征基因2](./md-image/随机森林筛选特征基因2.png){:width=180 height=180}
...
dev.off();
```
![随机森林筛选特征基因3](./md-image/随机森林筛选特征基因3.png){:width=180 height=180}
...
```
![随机森林筛选特征基因4](./md-image/随机森林筛选特征基因4.png){:width=180 height=180}
