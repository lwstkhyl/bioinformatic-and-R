...
##### count值
###### limma
需要包：`tidyverse`、`limma`、`pheatmap`、`edgeR`
```{r}
...
```
![差异表达分析6](./md-image/差异表达分析6.png){:width=250 height=250}
...
```
![差异表达分析7](./md-image/差异表达分析7.png){:width=250 height=250}
###### DESeq2
需要包：`DESeq2`
...
```
![差异表达分析8](./md-image/差异表达分析8.png){:width=250 height=250}
##### 查看以上4种分析结果
使用包：`VennDiagram`
```{r}
...
```
![差异表达分析9](./md-image/差异表达分析9.png){:width=250 height=250}
