...
rt <- cbind(cli, data);
```
![批量生存分析1](./md-image/批量生存分析1.png){:width=200 height=200}
批量生存分析：
```{r}
...
```
![自定义通路富集打分2](./md-image/自定义通路富集打分2.png){:width=200 height=200}
打分并标准化：
```{r}
# 打分
...
```
![自定义通路富集打分3](./md-image/自定义通路富集打分3.png){:width=200 height=200}
...
dev.off();
```
![自定义通路富集打分5](./md-image/自定义通路富集打分5.png){:width=200 height=200}
![自定义通路富集打分6](./md-image/自定义通路富集打分6.png){:width=200 height=200}
...
![IPS预测免疫治疗反应1](./md-image/IPS预测免疫治疗反应1.png){:width=200 height=200}
点击`Export all to TSV`下载
![IPS预测免疫治疗反应2](./md-image/IPS预测免疫治疗反应2.png){:width=200 height=200}
除此之外，还需要tpm表达矩阵
```{r}
library(reshape2);
library(ggpubr);
...
```
![IPS预测免疫治疗反应3](./md-image/IPS预测免疫治疗反应3.png){:width=200 height=200}
...
```
![IPS预测免疫治疗反应4](./md-image/IPS预测免疫治疗反应4.png){:width=200 height=200}
画提琴图：
```{r}
violin <- ggviolin(
  rt, x = "Genesets", y = "Expression", 
...
dev.off();
```
![IPS预测免疫治疗反应5](./md-image/IPS预测免疫治疗反应5.png){:width=200 height=200}
...
```
![IPS预测免疫治疗反应非TCGA1](./md-image/IPS预测免疫治疗反应非TCGA1.png){:width=200 height=200}
...
dev.off();
```
![IPS预测免疫治疗反应非TCGA3](./md-image/IPS预测免疫治疗反应非TCGA3.png){:width=200 height=200}
