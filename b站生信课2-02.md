...
```
![基因集富集分析GSEA3](./md-image/基因集富集分析GSEA3.png){:width=250 height=250}
**读取基因集文件**：
```{r}
# 使用KEGG基因集
...
```
![基因集富集分析GSEA4](./md-image/基因集富集分析GSEA4.png){:width=250 height=250}
**GSEA富集分析**：
```{r}
...
```
![基因集富集分析GSEA5](./md-image/基因集富集分析GSEA5.png){:width=250 height=250}
...
```
肿瘤组：
![基因集富集分析GSEA6](./md-image/基因集富集分析GSEA6.png){:width=250 height=250}
正常组：
![基因集富集分析GSEA7](./md-image/基因集富集分析GSEA7.png){:width=250 height=250}
图共分为上中下三部分：
...
```
![ssGSEA和GSVA1](./md-image/ssGSEA和GSVA1.png){:width=250 height=250}
**ssgsea**：
```{r}
# ssgsea分析
...
```
![ssGSEA和GSVA2](./md-image/ssGSEA和GSVA2.png){:width=250 height=250}
...
```
![ssGSEA和GSVA3](./md-image/ssGSEA和GSVA2.png){:width=250 height=250}
此时行名是样本名，列名是通路名
**提取差异显著的通路**：
```{r}
sig_gene <- c();  # 差异显著的基因
...
dev.off();
```
![ssGSEA和GSVA4](./md-image/ssGSEA和GSVA4.png){:width=250 height=250}
### 样本配对的差异表达分析
...
```
![样本配对的差异表达分析1](./md-image/样本配对的差异表达分析1.png){:width=250 height=250}
![样本配对的差异表达分析2](./md-image/样本配对的差异表达分析2.png){:width=250 height=250}
对两组数据进行处理：
...
```
![样本配对的差异表达分析3](./md-image/样本配对的差异表达分析3.png){:width=250 height=250}
**绘制图形**：
```{r}
...
dev.off();
```
![样本配对的差异表达分析4](./md-image/样本配对的差异表达分析4.png){:width=250 height=250}
...
```
![样本配对的差异表达分析5](./md-image/样本配对的差异表达分析5.png){:width=250 height=250}
![样本配对的差异表达分析6](./md-image/样本配对的差异表达分析6.png){:width=250 height=250}
...
```
![样本配对的差异表达分析7](./md-image/样本配对的差异表达分析7.png){:width=250 height=250}
